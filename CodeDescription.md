...
Compares TailSketch vs SandwichSketch for partial key queries.
...
└── src/
    ...
    ├── comparison_main.cpp        # TailSketch vs SandwichSketch comparison
    ...
    │   ├── TailSketch.h/cpp  # Hybrid frequency estimation (correlation-based)
...
TailSketch Memory Layout (64 KB per row = 320 KB total):
...
Algorithm ComputeComprehensiveMetrics(pattern, betasToTest, windowPackets,
    ...
    For each beta in betasToTest:
        ...
        For each (pk, gtFreq) in partialKeyGroundTruth:
            ...
            // Query TailSketch with beta adjustment
...
3. **Dual Sketch Comparison**: Evaluates both TailSketch and SandwichSketch
...
3. **Sketch Comparison**: Compare TailSketch vs SandwichSketch at scale
...
- **Throughput**: Higher is better; TailSketch typically faster than SandwichSketch
